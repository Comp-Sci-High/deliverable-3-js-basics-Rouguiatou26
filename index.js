...
favoriteMovie.quote = "Miraculous Ladybug!"
...
console.log ("My favorite movie is " + favoriteMovie.name+ " The genre is " + favoriteMovie.genre + " I rate it a " + favoriteMovie.rating + " and a cool quote is: " + favoriteMovie.quote)
